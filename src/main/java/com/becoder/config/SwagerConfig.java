...
public class SwagerConfig {
	...
	public OpenAPI openAPI() {
		...
		info.setTermsOfService("http://karniladri97@gmail.com");
		info.setContact(
				new Contact().email("karniladri97@gmail.com").name("Nairit Kar").url("http://karniladri97@gmail.com"));
		info.setLicense(new License().name("Enotes 1.0").url("\"http://karniladri97@gmail.com\""));
